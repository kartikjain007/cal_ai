  ...
  return res.json({
    ...
    instructions_for_use: {
      ...
      how_to_interpret: [
        ...
        "data_quality.accuracy_metrics.avg_confidence is the mean of each contributing meal's AI self-reported confidence (0.0-1.0), not a measured error rate — see accuracy_metrics.basis for what it does and doesn't represent.",
