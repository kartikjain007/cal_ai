...
export function buildUserPayload(
  ...
  const payload = {
    ...
    ai_disclosure: {
      ...
      message:
        "Your daily nutrition targets and pacing are generated by an AI recommendation model based on the profile data you provided. They are estimates, not medical advice.",
    },
  };
  if (token) {
