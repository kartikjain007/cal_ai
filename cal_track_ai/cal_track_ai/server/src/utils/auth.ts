...
export function buildUserPayload(
  ...
  const payload = {
    ...
    ai_disclosure: {
      ...
      message:
        "Your daily nutrition targets are computed from your profile data using a deterministic formula, not an AI/ML model. They are estimates, not medical advice.",
    },
  };
  if (token) {
